...
public class ChatBubbleButtonNotMy extends Button {
  ...
  public ChatBubbleButtonNotMy(Context context) {
    super(context);
    init(null);
  }

  public ChatBubbleButtonNotMy(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  public ChatBubbleButtonNotMy(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void init(AttributeSet attrs) {
    ...
    try {
      ...
      mFill.getPaint().setColor(a.getColor(R.styleable.ChatBubbleButtonNotMy_boxFillColor, r.getColor(R.color.bubble_not_my)));
